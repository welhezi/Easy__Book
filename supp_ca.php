<!DOCTYPE html>
    <html lang="en">
     <head>
       ...
       body {
           background-image: url(https://s-i.huffpost.com/gen/4163610/images/o-ROOM-facebook.jpg); /* The image used for background*/
   ...
   <div class='w3-margin'>
   <p class='w3-large w3-text-black'><h1>DELETE CATEGORIE OF A ROOM !</h1></p>
